        ...
        if (com_media) {
            ...
            const callback = (mutationList, observer) => {
                ...
                Array.prototype.forEach.call(elements_1, function (el, i) {
                    ...
                    var info_container = el.querySelector('.media-browser-item-info');
                    console.log(info_container);
                    if (info_container.textContent.trim().endsWith('.unlock')) {
                        el.parentNode.setAttribute("hidden", true);
                        ...
                        if (preview_container) {
                            ...
                            if (extension == 'zip') {
                                item_container.innerHTML = '<div class="file-background"><div class="folder-icon"><span class="fa fa-file-archive"></span></div></div>';
                            } else {
